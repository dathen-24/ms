...
export const addAlbum = TryCatch(async (req: AuthencatedRequest, res: Response) => {
...
export const addSong = TryCatch(async (req: AuthencatedRequest, res: Response) => {
  if (req.user?.role !== "admin") {
    res.status(401).json({
      message: "You are not admin",
    });
...
export const addThumbnail = TryCatch(async (req: AuthencatedRequest, res: Response) => {
  if (req.user?.role !== "admin") {
    res.status(401).json({
      message: "You are not admin",
    });
...
export const deleteAlbum = TryCatch(async (req: AuthencatedRequest, res: Response) => {
  if (req.user?.role !== "admin") {
    res.status(401).json({
      message: "You are not admin",
    });
...
export const deleteSong = TryCatch(async (req: AuthencatedRequest, res: Response) => {
  if (req.user?.role !== "admin") {
    res.status(401).json({
      message: "You are not admin",
    });
...
export const updateAlbum = TryCatch(async (req: AuthencatedRequest, res: Response) => {
  if (req.user?.role !== "admin") {
    res.status(401).json({
      message: "You are not admin",
    });
...
export const updateSong = TryCatch(async (req: AuthencatedRequest, res: Response) => {
  if (req.user?.role !== "admin") {
    res.status(401).json({
      message: "You are not admin",
    });
